	...
	return (
		<html lang="en">
			...
			<body class="font-forum">
				<section class="flex flex-wrap space-x-3 space-y-4 min-h-[80vh] max-sm:min-h-[90vh] px-8 max-md:pt-20 justify-around items-center inset-0 bg-[linear-gradient(to_right_bottom,rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url('https://imagescdn.homes.com/i2/bRuQxp-5oG4CrZgJ0vb1z8OnBtQoY9k3yIt0m5imaRc/117/gann-academy-waltham-ma-primaryphoto.jpg?p=1')] bg-cover bg-center backdrop-blur-sm">
					<div class="lg:w-[40rem] max-lg:w-[25rem] max-md:w-full max-lg:shrink-0 h-full flex items-center justify-center flex-col shrink">
						...
						<p class="my-5 text-white text-center">
							Official Documentation for all FTC code written for
							the RABBI Robotics Team
						</p>
				...
				<section
					id="getstarted"
					class="flex px-12 py-16 items-center justify-center flex-col bg-slate-100"
				>
					<h1 class="text-6xl font-bold mb-8 flex">
						About<p class="ml-4 text-red-900 tracking-wide">
							RABBI
						</p>
					</h1>
					<div class="flex flex-wrap justify-center items-center sm:space-x-12 mb-16">
						...
						<p class="text-lg w-[35rem] max-sm:w-[100%] text-center">
							Rabbi was founded in 2010, Lorem ipsum, dolor sit
							amet consectetur adipisicing elit. Id officia ea
							ipsam rem placeat! Voluptates placeat eveniet harum
							impedit dolorem officiis fuga, beatae eos, odio
							reprehenderit, quisquam eaque quam nam.
						</p>
					</div>
					...
					<p class="space-y-4 text-2xl text-center md:w-[50rem] mb-8">
						...
						<NormalLink link="https://adoptium.net" text="Here" />.
						If you already have both, then move on to the follow
						steps:
					</p>
					<p class="text-2xl text-center">
						Open Up the Terminal with you desired directory, and run
						this command to download the code:
					</p>
					<p class="bg-slate-900 p-2 rounded-lg mb-4">
						<code class="text-white">
							$ <b class="text-red-700">git</b>{" "}
							clone
							https://github.com/RABBI-4466/FTC-2024-2025.git
						</code>
					</p>
					<p class="text-md text-red-900 mb-12 text-center">
						If the clone didn't work, make sure that you have proper
						access to the repository, otherwise it won't work
					</p>
					<h1 class="text-6xl font-bold mb-8 text-center">
						Installing Android Studio IDE
					</h1>
					<p class="space-y-4 text-2xl text-center md:w-[50rem] mb-4">
						In order to run and use the code properly, you'll need
						to install the{" "}
						<b class="text-red-700 font-bold">Android Studio IDE</b>
						{" "}
						<NormalLink
							link="https://developer.android.com/studio"
							text="Here"
						/>. Android Studio is needed, since we use Android
						Phones for the custom FTC App to connect to the robots.
					</p>
					<p class="space-y-4 text-2xl text-center md:w-[50rem] mb-4">
						Along with installing Android Studio, you'll also need
						to install the{"  "}
						<b class="text-red-700 font-bold">
							Android Debug Bridge (ADB)
						</b>. Here's how you download ADB on different operating
						systems:
					</p>
					...
					<p class="mb-8 text-center">
						There are many other ways to install ADB, so if you have
						a preferred alternative, that is completely fine
					</p>
					<RedLinkBtn

        ...
        <footer class="flex flex-col items-center bg-slate-900 p-12">
            <div class="flex flex-wrap p-12 justify-center items-center">
                <div class="flex flex-col justify-center items-center h-[20rem] mx-4">
                    ...
                    <a href="/#" class="text-cyan-400 transition hover:text-white text-2xl mb-2">
                        Home
                    </a>
                    <a href="#" class="text-cyan-400 transition hover:text-white text-2xl mb-2">
                        Documentation
                    </a>
                    <a href="/signup" class="text-cyan-400 transition hover:text-white text-2xl mb-2">
                        Sign Up
                    </a>
                    <a href="/login" class="text-cyan-400 transition hover:text-white text-2xl mb-2">
                        Log In
                    </a>
                </div>
                <div class="flex flex-col justify-center items-center h-[20rem] mx-4">
            ...
            <div class="p-12 border-t-[3px] flex items-center justify-between max-sm:justify-center border-t-white max-sm:flex-wrap w-full">
                ...
                <p class="text-slate-700 text-[1rem] text-center">Made By Eitan Brochstein</p>
            </div>
        </footer>
    );
}
